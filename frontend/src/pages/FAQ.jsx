...
const FAQ = () => {
  ...
  const faqData = [
    {
      question:
        "How do I sign up for a developer account on the Arcelor development portal?",
      answer:
        "On the developer portal, click the Sign up button at the right top corner. The portal is a self-service tool that will guide you through account creation. After creating an account and accepting the Arcelor API Portal and Services Agreement, you can start developing apps.",
    },
    {
      question: "Who is this for?",
      answer:
        "We are currently publishing this for new developers or existing partners with a new initiative. If you do not have an integration with Arcelor, use these APIs to get started.",
    },
    {
    ...
    {
      // 🌟 MAGIC FIX HERE: We use \n inside the quotes to make new lines!
      question: "What are the Organisation Administrator’s responsibilities?",
      answer:
        "The Organisation Administrator is your company’s representative for the Arcelor API Portal. This person has overall responsibility for the account, and has access to all the services and functions available on the site. Main responsibilities include:\n\n1) Adding, deleting and managing your organisation’s developers\n2) Adding, deleting and managing applications\n3) Editing organisational details\n4) Requesting API keys and authentication\n5) Changing API Plans or Account Plans\n6) Checking API usage and analytics.\n\nThe Organisation Administrator is Arcelor’s first point of contact.",
    },
    {
      question: "How do I add a user to my organization’s developer account?",
      answer:
        "Only users with the enterprise administrator role can add users. You can manage your users and permissions at the User Management page.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, sandbox APIs are currently restricted to a limited number of calls, according to the API Plan’s context.",
    },
    {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          <div className="bg-[#025f61]/10 dark:bg-[#025f61]/20 p-4 rounded-full mb-4">
            <HelpCircle
              size={40}
              className="text-[#025f61] dark:text-teal-400"
            />
          </div>
          <h1 className="text-4xl lg:text-5xl font-extrabold text-slate-800 dark:text-white mb-4 drop-shadow-sm transition-colors">
            How can we{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#025f61] to-[#0a5e54] dark:from-teal-400 dark:to-teal-200">
              help you?
            </span>
          </h1>
          <p className="text-slate-600 dark:text-teal-100/70 text-lg max-w-2xl transition-colors">
            ...
            below to learn everything about the Arcelor API Portal.
          </p>
        </div>
        ...
        {filteredFaqs.length === 0 && (
          <div className="text-center py-10 bg-white dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm">
            <p className="text-slate-500 dark:text-white/60 text-lg">
              Oops! We couldn't find any results for "{searchQuery}". Try
              another word!
            </p>
          </div>
        )}
        ...
        <div className="space-y-4">
          {filteredFaqs.map((faq, index) => {
            const actualIndex = faqData.findIndex(
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`p-1 rounded-full transition-colors duration-300 ml-4 flex-shrink-0 ${
                      isOpen
                        ? "bg-[#025f61]/10 dark:bg-teal-500/20"
                  ...
                  >
                    <ChevronDown
                      className={`transition-transform duration-300 ${
                        isOpen
                          ? "rotate-180 text-[#025f61] dark:text-teal-400"
                          : "rotate-0 text-slate-400 dark:text-white/50"
                      }`}
                      size={20}
                    />
                  </div>
                ...
                >
                  <div className="overflow-hidden">
                    <div className="px-6 pb-6 text-slate-600 dark:text-black leading-relaxed border-t border-slate-500 dark:border-white pt-4 whitespace-pre-line">
                      {faq.answer}
                    </div>
                  </div>
                </div>
