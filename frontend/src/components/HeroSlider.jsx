...
--data '{
  ...
  return (
    <div className="relative pt-24 lg:pt-32 pb-32 lg:pb-40 overflow-hidden bg-slate-50 dark:bg-[#011112] transition-colors duration-500 min-h-[95vh] flex items-center">
      ...
      <div
        className="absolute top-[-10%] left-[-10%] w-[800px] h-[800px] bg-[#025f61]/20 dark:bg-[#025f61]/30 rounded-full blur-[120px] animate-pulse pointer-events-none"
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-16 pt-10 pb-15">
          ...
          <div className="w-full lg:w-[48%] text-left">
            ...
            <p className="text-base lg:text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-xl leading-relaxed font-medium">
              Connect your application to our enterprise-grade infrastructure.
              Instantly deploy secure, scalable APIs built specifically for
              modern financial workflows.
            </p>

            <div className="flex flex-wrap items-center justify-start gap-4">
              {/* 👈 Added onClick to go to /add-api */}
              <button
                onClick={() => navigate("/add-api")}
                className="px-6 py-3 lg:px-8 lg:py-4 bg-[#025f61] hover:bg-[#014849] text-white rounded-xl font-bold text-base lg:text-lg transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#025f61]/40 flex items-center gap-3"
              >
                Start Building <ArrowRight size={20} />
              </button>

              {/* 👈 Added onClick to go to /sandbox */}
              <button
                onClick={() => navigate("/sandbox")}
                className="px-6 py-3 lg:px-8 lg:py-4 bg-white dark:bg-[#0a1f20] border-2 border-slate-200 dark:border-white/10 hover:border-[#025f61] dark:hover:border-teal-500 text-slate-800 dark:text-white rounded-xl font-bold text-base lg:text-lg transition-all hover:-translate-y-1 flex items-center gap-3 shadow-sm"
              >
            ...
            <div className="relative w-full max-w-[600px] mt-10 lg:mt-0">
                        ...
                        <div key={i} className="whitespace-pre">
                          ...
                          <span
                            ...
                            dangerouslySetInnerHTML={{
                              __html: line
                                .replace(
                                  /await|const|import|from/g,
                                  '<span class="text-purple-400">$&</span>',
                                )
                                .replace(
                                  /fetch|requests\.request|console\.log|print/g,
                                ...
                                .replace(
                                  /5000/g,
                                  '<span class="text-orange-300">5000</span>',
                                ),
                            }}
                          />
                        </div>
              ...
              <div className="absolute -bottom-12 -left-4 md:-left-12 bg-white dark:bg-[#112324] p-4 lg:p-5 rounded-xl shadow-2xl border border-slate-200 dark:border-teal-900/50 z-20 animate-[bounce_4s_infinite] w-[260px] lg:w-[280px]">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-[10px] lg:text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                    Live Response
                  </span>
    ...
    "verified": true
        ...
        <div className="flex flex-wrap items-center gap-6 lg:gap-12 pt-4">
          <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400 font-semibold text-sm lg:text-base">
            <Activity size={20} className="text-[#025f61] dark:text-teal-400" />{" "}
            99.99% Uptime
          </div>
          <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400 font-semibold text-sm lg:text-base">
            <Zap size={20} className="text-[#025f61] dark:text-teal-400" /> 50ms
            Latency
          </div>
          <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400 font-semibold text-sm lg:text-base">
            <Shield size={20} className="text-[#025f61] dark:text-teal-400" />{" "}
            Bank-Grade Security
          </div>
        </div>
      </div>
