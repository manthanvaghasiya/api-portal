...
const JourneyLive = () => {
  return (
    // 🌟 Removed pure white! Now uses a soothing, soft gray-blue tone.
    <section className="py-16 lg:py-24 bg-slate-50 dark:bg-[#011112] overflow-hidden border-t border-slate-200/60 dark:border-white/5 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="relative flex flex-col lg:flex-row justify-between items-center lg:items-start max-w-5xl mx-auto z-10 gap-8 lg:gap-0">
          ...
          {/* STEP 1: Sandbox - 🌟 Orbs are now frosted glass! */}
          <div className="flex flex-col items-center w-full max-w-[280px] lg:w-64 group cursor-pointer">
            <div className="w-20 h-20 lg:w-24 lg:h-24 bg-white/70 backdrop-blur-md dark:bg-[#0d151c] rounded-full border-4 border-white dark:border-orange-500/10 flex items-center justify-center shadow-lg shadow-orange-900/5 dark:shadow-none group-hover:scale-110 group-hover:border-orange-400 dark:group-hover:border-orange-500 transition-all duration-300 mb-4 lg:mb-6">
            ...
            <p className="text-center text-slate-600 dark:text-slate-400 text-sm leading-relaxed px-4 lg:px-0">
          ...
          {/* STEP 2: UAT */}
          <div className="flex flex-col items-center w-full max-w-[280px] lg:w-64 group cursor-pointer">
            <div className="w-20 h-20 lg:w-24 lg:h-24 bg-white/70 backdrop-blur-md dark:bg-[#0d151c] rounded-full border-4 border-white dark:border-blue-500/10 flex items-center justify-center shadow-lg shadow-blue-900/5 dark:shadow-none group-hover:scale-110 group-hover:border-[#005587] dark:group-hover:border-[#005587] transition-all duration-300 mb-4 lg:mb-6">
          ...
          {/* STEP 3: Production */}
          <div className="flex flex-col items-center w-full max-w-[280px] lg:w-64 group cursor-pointer">
            <div className="w-20 h-20 lg:w-24 lg:h-24 bg-white/70 backdrop-blur-md dark:bg-[#0d151c] rounded-full border-4 border-white dark:border-red-500/10 flex items-center justify-center shadow-lg shadow-red-900/5 dark:shadow-none group-hover:scale-110 group-hover:border-[#b91c1c] dark:group-hover:border-[#b91c1c] transition-all duration-300 mb-4 lg:mb-6">
        ...
        {/* 🌟 Softened the disclaimer box color */}
        <div className="mt-16 lg:mt-24 text-center bg-slate-100/50 dark:bg-[#0a1718] py-4 px-4 lg:px-6 rounded-xl border border-slate-200/60 dark:border-white/5 max-w-4xl mx-auto">
          <p className="text-[10px] lg:text-xs text-slate-500 dark:text-slate-500 italic leading-relaxed">
